...
import { fetchMessages, addMessage, resetMessages } from '../features/messages/messagesSlice'
...
const ChatBox = () => {
    ...
    return user && (
        <div className='flex flex-col h-screen'>
            <div className='flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-gradient-to-r from-primary-50 to-primary-50 border-b border-gray-300'>
            ...
            <div className='px-4'>
                <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
                    ...
                    <button onClick={sendMessage} className='bg-gradient-to-br from-primary-500 to-pruple-600 hover:from-primary-700 hover:to-primary-800 active:scale-95 cursor-pointer text-white p-2 rounded-full'>
